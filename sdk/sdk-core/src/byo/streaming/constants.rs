...
const _: () = assert!(V7_HEADER_MIN == 1709, "V7 header size changed — update streaming code");
const _: () = assert!(V7_FOOTER_LEN == 32,   "V7 footer size changed — update streaming code");
const _: () = assert!(V7_ENCRYPT_CHUNK_SIZE == 512 * 1024, "V7 encrypt chunk size changed");
