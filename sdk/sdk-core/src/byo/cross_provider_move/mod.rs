...
mod tests {
    ...
    fn basic_plan() -> CrossProviderMovePlan {
        CrossProviderMovePlan::build(42, "ref/abc", "gdrive", "dropbox", None, "photo.jpg", vec![])
    }
    ...
    fn source_blob_deleted_before_vault_row() {
        ...
        let del_row = steps
            ...
            .unwrap();
        assert!(del_blob < del_row, "blob delete must precede vault row delete");
    }
    ...
    fn insert_dest_before_delete_source() {
        ...
        let delete = steps
            ...
            .position(|s| matches!(s, MoveStep::DeleteSourceVaultRow { .. }))
            .unwrap();
        assert!(insert < delete, "InsertDestVaultRow must precede DeleteSourceVaultRow");
    }
    ...
    fn make_share(share_id: &str, file_id: u64, variant: &str, revoked: bool) -> ShareRow {
        ShareRow {
            ...
            provider_ref: format!("SecureCloud/data/{share_id}"),
    ...
    fn pre_revokes_field_is_carried_in_plan() {
        ...
        let plan = CrossProviderMovePlan::build(
            42, "ref/abc", "gdrive", "dropbox", None, "photo.jpg", pre_revokes,
        );
