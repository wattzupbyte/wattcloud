...
declare module '@wattcloud/wasm' {
  ...
  export function byo_enrollment_session_encrypt_payload(sessionId: number, payloadB64: string): any;
  export function byo_enrollment_session_decrypt_payload(sessionId: number, envelopeB64: string): any;
  ...
  export function byo_vault_generate_keypair_wrapped(sessionId: number): any;
  export function byo_vault_seal_device_signing_key(sessionId: number, deviceIdB64: string, seedB64: string): any;
  // WebAuthn PRF-gated device-key protection (see SECURITY.md §12).
  export function webauthn_derive_wrapping_key(prfOutput: Uint8Array): Uint8Array;
  export function webauthn_wrap_device_key(deviceKey: Uint8Array, wrappingKey: Uint8Array): Uint8Array;
  export function webauthn_unwrap_device_key(wrapped: Uint8Array, wrappingKey: Uint8Array): Uint8Array;
  export function webauthn_generate_device_key(): Uint8Array;
