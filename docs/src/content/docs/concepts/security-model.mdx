...
in [`SECURITY.md`](https://github.com/thewattlabs/wattcloud/blob/main/SECURITY.md).
...
Full discussion in [`SECURITY.md` §5](https://github.com/thewattlabs/wattcloud/blob/main/SECURITY.md#5-post-quantum-strategy).
...
[`SECURITY.md` §13.1](https://github.com/thewattlabs/wattcloud/blob/main/SECURITY.md#131-systemd-sandboxing).
